...
#define TEMP_SENSOR _BV(ADC_MUX_BIT_3)
#define ONE_ONE_V _BV(ADC_MUX_BIT_1) | _BV(ADC_MUX_BIT_2) | _BV(ADC_MUX_BIT_3)
#define ADC_GROUND _BV(ADC_MUX_BIT_0) | _BV(ADC_MUX_BIT_1) | _BV(ADC_MUX_BIT_2) | _BV(ADC_MUX_BIT_3)
